    ...
    <Layout>
      ...
      <div className="my-40 md:mx-20 mx-10">
        <div className="flex flex-col gap-28 w-full">
          {projects.map(({ name, details, image }, index) => (
            <div key={name}>
              <div
                className={`flex items-center md:gap-10 gap-4 flex-col ${
                  index % 2 === 1 ? "md:flex-row-reverse" : "md:flex-row"
                }`}
              >
                <div
                  className={`overflow-hidden md:border-[18px] border-[10px] border-white ${
                    index % 2 === 0
                ...
                <div className="flex flex-col items-start text-center">
                  <div className="md:text-[2rem] text-xl w-full font-bold leading-[40px]">
                    {name}
                  </div>
                  <div className="md:text-[1.5rem] text-lg w-full font-semibold leading-[40px]">
                    {details}
                  </div>
                </div>
              </div>
