    ...
    >
      ...
      >
        ...
        >
          ...
          <div className='absolute bottom-10 -left-10 text-[42px] text-[rgba(255,255,255,0.9)] group-hover:text-[rgba(255,255,255,1)] transition-all cursor-default capitalize  font-semibold '>
            {title}
          </div>
        </div>
      </Tilt>
