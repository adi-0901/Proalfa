...
const Tile = ({
  ...
  return (
    <div
      className="flex flex-col justify-center items-center hover:scale-110  group transition-all duration-1000 absolute "
      style={{
...
const projects = [
  {
    name: "RAW MATERIALS",
    details: "12000 SQFT",
    description: `High quality raw materials are transported to our factory`,
    image: RawMaterialsStep,
